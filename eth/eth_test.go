...
func TestUnsignedRaw(t *testing.T) {
	...
	frIndex := 0
	s, _ := UnsignedRaw(nonce, to, amount, gasLimit, gasPrice, frIndex, nil)
	// LnuzKERgkY7k63gL5sycnkqpf13MVAN3YXxvkWV6A6Arx9quhb9oSVATJ1NxncKHgDEbNTud9QhE3fWpnFsdJrh4g841r7BphbSssmgVGdMLGStcDoWdwi5mp2tZiCGWYWGFXGijKdqhnkS8QYHrEmZty3Nzp3D7NpyghnpSCtEtstvB7A3mm9zhgmeeTmNLEDQCF9r8TidyJeG2zjAmCcUyVfuzragMqpPw9MFe3mRMZ7hiseLrp
	fmt.Println("待签名数据:", s)
}
...
func TestERC20unsignedRaw(t *testing.T) {
	...
	frIndex := 0
	s, _ := ERC20unsignedRaw(nonce, token, to, amount, gasLimit, gasPrice, frIndex)
	fmt.Println("待签名数据:", s)
	TEST = true
	fmt.Println("\n######################################## Erc20 SignedRaw ########################################")
	xpvk := "xprv9s21ZrQH143K3YFpEoWtTFghkAis2Ae8pi6PYW7DxC7ZsYSAAx12we34hJ3NCvN3j918bG5MeBwm2KQCrwTMbM3V4qb1WvVcaygAp6WdVBL"
